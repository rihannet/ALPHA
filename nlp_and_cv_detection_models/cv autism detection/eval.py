...
class FrameDataset(Dataset):
    def __init__(self, path, n_frames, training=False):
        ...
        # Print class labels for each folder
        for class_name in self.class_names:
            print(f"Class '{class_name}' has label {self.class_ids_for_name[class_name]}")
...
# Training function
def train_model(model, criterion, optimizer, num_epochs=16):
